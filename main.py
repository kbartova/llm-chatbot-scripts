...
qa_system_prompt = """"
Use the following all pieces of context in documents to answer the question at the end.
You have to answer refer to all documents each time to answer the question.
If you don't know the answer, just say that you don't know, don't try to
make up an answer. You have to answer with only contents in documents.
{context} 
"""
...
def proprietary_assistant():
    ...
    return jsonify({'result': str(ai_msg)[9:-1]})
